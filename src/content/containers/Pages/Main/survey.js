    ...
    <div className="container">
      <div className="row">
        ...
        <div className="offset-md-1 col-lg-4 d-flex align-items-center">
          <img className="img-fluid" id="image" alt="survey" src={require('../../../../content/theme/custom/images/survey.png')} />
        </div>
              ...
              <div className="col-sm-2 p-2 d-flex align-items-center">
                <div className="header-image">
                  <div className="wow bounceIn" data-wow-duration="1s" data-wow-delay="0.75s">
                    <img className="img-fluid" alt="survey" src={require('../../../../content/theme/custom/images/surveyResults.png')} />
                  </div>
                </div>
              </div>
              ...
              <div className="col-sm-2 d-flex align-items-center">
                <div className="header-image">
                  <div className="wow bounceIn" data-wow-duration="1s" data-wow-delay="0.95s">
                    <img className="img-fluid" alt="survey" src={require('../../../../content/theme/custom/images/seedSurvey.png')} />
                  </div>
                </div>
              </div>
              <div className="col-sm-8 text-center text-sm-left">
              ...
              <div className="col-sm-2 d-flex align-items-center">
                <div className="header-image">
                  <div className="wow bounceIn" data-wow-duration="1s" data-wow-delay="1.15s">
                    <img className="img-fluid" alt="survey" src={require('../../../../content/theme/custom/images/surveyOnly.png')} />
                  </div>
                </div>
              </div>
              <div className="col-sm-8 text-center text-sm-left">
