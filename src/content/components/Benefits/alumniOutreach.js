      ...
      <div className="alumniRelations mt-5">
        <div className="container">
          ...
          <div className="row justify-content-center pb-md-5">
            ...
            <h5>AlumniBase is designed to help your alumni relations teams work smarter with available resources. Big data, though anonymised, can help identify which fundraising campaigns may be most successful with particular sub-groups of graduates. Further, a strong relationship is based on a two-way flow of value. </h5>
          </div>
          <div className="row justify-content-center pb-md-5">
            ...
            <div className="col-lg-6 order-lg-1 d-flex justify-content-center">
              <div className="card">
                <ul className="list-group list-group-flush">
                  ...
                  <li className="list-group-item">Oxford and Cambridge total is 366</li>
                  <li className="list-group-item">More than half of lower performing departments were formed before 2004</li>
                  <li className="list-group-item">Five / 15 best performing fundraisers not part of the Russel Group</li>
                </ul>
              </div>
            </div>
          </div>
