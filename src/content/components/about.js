        ...
        <div className="container" id="aboutPage">
          ...
          <div className="row">
            <div className="col">
              ...
              <div className="row">
                <div className="col">
                  <h6 className="text-justify">While we helped many users understand if their pay was fair and to negotiate higher pay when it wasn’t, we found many felt their options were limited as their education was completed and they were embedded in an industry.
